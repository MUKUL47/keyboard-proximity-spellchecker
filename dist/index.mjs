...
var SpellChecker = class {
  constructor() {
    ...
    this.trie = {};
    words_dataset_default.forEach(
      (word) => this.iterateTrie(word.toLowerCase().split(""), this.trie)
    );
  }
  iterateTrie(chars, t, idx = 0) {
    const c = chars[idx++];
    if (!c)
      return;
    if (t[c]) {
  ...
  suggestCorrections(wrongSentence) {
    const suggestions = {};
    wrongSentence.forEach((word) => {
      ...
      const permutationStrs = chars.map(
        (char) => {
          var _a;
          return (_a = this.keyboardProximityMap[char]) != null ? _a : [];
        }
      );
  ...
  isValidWord(word, i = 0, t = this.trie) {
    var _a;
    const c = word[i];
    if (word.length - 1 === i && !!((_a = t[c]) == null ? void 0 : _a["_"]))
      return true;
    if (t[c])
      return this.isValidWord(word, i + 1, t[c]);
    return false;
  }
  getStrPermuation(strs) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  suggestButton == null ? void 0 : suggestButton.addEventListener("click", () => {
    var _a;
    const input = (_a = inputField == null ? void 0 : inputField.value) == null ? void 0 : _a.trim();
    if (input) {
